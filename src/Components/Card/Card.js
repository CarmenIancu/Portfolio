...
<article className='tc dib br3 pd3 ma2 grow bw2 shadow5 ba dark-gray b--black-10 mv4 w-100 h-100 w-50-m w-25-l mw5 '>
  ...
  <div className='pa2 ph3-ns pb3-ns'>
    ...
    <a className='f6 link dim br3 ph3 pv2 mb2 dib dark-gray customcolor' href={props.project.page} target='_blank noopener noreferrer'>LIVE</a>
    <a className='f6 link dim br3 ph3 pv2 mb2 dib dark-gray customcolor' href={props.project.repo} target='_blank noopener noreferrer'>REPO</a>
</div>
</article>
			)
	};
